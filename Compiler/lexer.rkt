...
(define Nand2TetrisLexer
  ...
  (lexer [(union "class" "constructor" "function" "method" 
         ...
         [(or (:numeric)
              (: (char-range #\1 #\9) (repetition 1 3 numeric))
              (: "12" (repetition 4 4 numeric))
              (: "3" (char-range #\0 #\1) (repetition 3 3 numeric))
              (: "32" (char-range #\0 #\6) (repetition 2 2 numeric))
              (: "327" (char-range #\0 #\5) numeric)
              (: "3276" (char-range #\0 #\7)))
          ;=>
          (begin
