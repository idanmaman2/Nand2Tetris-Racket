...
(require racket/list)
(require "varinfo.rkt")
;this code will contain commands exported that will give to file vm commands by appropriate values
...
(define (reset-label-index) (set! labael-index 0)) 
